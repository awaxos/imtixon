...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'aiter', 'all', 'any', '.venv.bin', 'bool', 'bytearray',
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all', 'any', 'apply', 'basestring', '.venv.bin',
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all', 'any', 'apply', 'basestring', '.venv.bin', 'bint',
